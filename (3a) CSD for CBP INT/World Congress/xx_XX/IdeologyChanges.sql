...
UPDATE language_xx_XX
SET Text = 'No new [ICON_INTERNATIONAL_TRADE] Trade Routes or Deals can be established between the chosen Civilization and any other Civilization. Warmonger penalty greatly reduced when declaring war on the sanctioned Civilization or conquering cities owned by them.'
